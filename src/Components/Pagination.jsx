...
export default function Pagination({ pageHandle, page, lastPage }) {
  return (
    <div className="flex justify-center items-center pt-2 pb-2">
      <div className="btn-group">
          ...
          page > 3 && (
            <>
              ...
              {/* ********************** */}
              {
                // CASE: 04
                page > 5 && (
                  <button className="btn btn-sm btn-disabled bg-info text-white font-extrabold">
                    ...
                  </button>
                )
              }
        ...
        <button className="btn btn-sm btn-disabled bg-info text-white">
          {page}
        </button>
